...
public class PartidaDAO {
    ...
    public void guardarPartida(Partida partida) {
        ...
        Document docNivel = new Document("idNivel", partida.getNivel().getIdNivel())
                .append("nombre", partida.getNivel());
        ...
        // Operación Upsert: Si el ID ya existe lo actualiza, si no, inserta una nueva partida
        coleccion.updateOne(
    ...
    private Partida mapearDocumentoAPartida(Document doc) {
        ...
        // Reconstruir Nivel (Solo necesitamos el ID y Nombre para cargar el estado del juego)
