...
/**
 * Gestiona la extracción de los lugares del crimen desde la colección
 * "Escenario" en MongoDB.
 */
public class EscenarioDAO {
	 ...
	 * * @param idEscenario El código identificador del lugar (por ejemplo,
	 * "E_FORJA").
	 * 
	...
	/**
	 * Extrae la lista completa de todos los lugares del castillo guardados en la
	 * base de datos. * @return Una lista (List) que contiene todos los escenarios
	 * del juego.
	 */
