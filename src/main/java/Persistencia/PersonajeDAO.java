...
/**
 * Data Access Object (DAO) encargado de recuperar la información de los
 * sospechosos desde la colección "Personaje" en MongoDB.
 */
public class PersonajeDAO {
	 ...
	 * 
	 * @return Un objeto Personaje relleno con la información de la base de datos, o
	 *         null si no existe.
	 */
