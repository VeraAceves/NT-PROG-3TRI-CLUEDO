...
public class ArmaDAO {
	...
	/**
	 * Busca un arma en la base de datos utilizando su id. * @param idArma El código
	 * identificador del arma (por ejemplo, "A_CANDELABRO").
	 * 
	 * @return Un objeto Arma con todos sus datos, o null si no se encuentra en la
	 *         base de datos.
	 */
	...
	/**
	 * Recupera todas las armas disponibles en el catálogo del juego. * @return Una
	 * lista (List) con todos los objetos Arma instanciados.
	 */
